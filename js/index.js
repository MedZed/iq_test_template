...
var response = $.getJSON('https://opentdb.com/api.php?amount=5&difficulty=easy&type=multiple', function (sources_data) {
// console.log(sources_data.results);

data = sources_data.results
...
function Questions() {
  ...
  for (var i = 0; i < data.length; i++) {
    question = {
      question_string: data[i].question,
      choices: {
